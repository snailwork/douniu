...
#if APPID == 2001
    #define APP_ID          @"wx1ff2b3f8aa61d4e2"               //APPID
    #define APP_SECRET      @"d4624c36b6795d1d99dcf0547af5443d" //appsecret
#else
    #define APP_ID          @"wxd4acb2f28be9e5bb"               //APPID
    #define APP_SECRET      @"e3a871269ee21c63322e3ce0736fa06b" //appsecret
#endif

//商户号，填写商户对应参数
#define MCH_ID          @"1263673201"
//商户API密钥，填写相应参数
#define PARTNER_ID      @"QianshouHudongWangluokeji5201314"
//支付结果回调页面
